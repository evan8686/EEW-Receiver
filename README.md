...
> 
> **虽然应用开放了多源订阅功能，但同时维持大量 WebSocket 长链接并发，极易被安卓系统底层识别为异常网络行为或恶意耗电，从而触发强制断流与杀后台。本人作为业余开发者，无义务也无精力为这种严重偏离软件设计初衷的“硬核把玩”需求提供异常排查与技术支持。**
> 
...
> 
> **🔍 关于漏报的责任归属与排查建议：**
> **本应用不具备独立测定和下发数据的能力，预警数据完全依赖于 Wolfx 开源 API 转发。如果您在仅开启单个源，且确保 APP 后台绝对存活的情况下遭遇漏报，请在提交 Issue 前，自行使用 WebSocket 工具确认 Wolfx 在当时是否成功下发了该次地震报文。**
> * **若 Wolfx 未下发：此为上游数据源原因，APP 无法无中生有，请勿向本项目反馈。**
> * **若确认 Wolfx 已下发，但 APP 未响应：此时才可能属于应用层面的逻辑异常。非常欢迎您携带抓取到的原始报文日志提交 Issue 协助排查。感谢理解！**
